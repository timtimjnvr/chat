	...
	var (
		...
		tests = []struct {
		...
		}{
			{
				...
				expectedRunes: []rune{36, 52, 98, 56, 101, 49, 53, 51, 98, 45, 56, 51, 52, 102, 45, 52, 49, 57, 48, 45, 98, 53, 100, 51, 45, 97, 98, 97, 50, 102, 51, 53, 101, 97, 100, 53, 54, 4, 116, 111, 116, 111, 6, 74, 39, 97, 105, 109, 101, 20, 48, 48, 48, 49, 45, 48, 49, 45, 48, 49, 84, 48, 48, 58, 48, 48, 58, 48, 48, 90},
			},
		}
	)

	for i, test := range tests {
		res := test.inputStruct.ToRunes()
